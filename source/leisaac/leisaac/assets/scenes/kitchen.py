...
KITCHEN_WITH_TESTCUBE_USD_PATH = str(SCENES_ROOT / "kitchen_with_testcube" / "scene.usd")

KITCHEN_WITH_TESTCUBE_CFG = AssetBaseCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path=KITCHEN_WITH_TESTCUBE_USD_PATH,
    )
)
